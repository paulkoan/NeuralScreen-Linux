...
```
tests/test_m0_env_gate.py::test_m0_no_ngx_core_not_found_error PASSED    [ 38%]
tests/test_m0_env_gate.py::test_m0_no_platform_error PASSED              [ 39%]
================== 1 failed, 67 passed, 15 skipped in 12.86s ===================
```
...
Commit and push `test-results/20260916T105502Z/` — it is read directly from the repo.
