...
```
tests/test_m0_env_gate.py::test_m0_no_ngx_core_not_found_error SKIPPED   [ 45%]
tests/test_m0_env_gate.py::test_m0_no_platform_error SKIPPED (M0 run...) [ 45%]
======================= 208 passed, 26 skipped in 18.27s =======================
```
...
Commit and push `test-results/20260919T074818Z/` — it is read directly from the repo.
