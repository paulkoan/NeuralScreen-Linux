...
```
tests/test_m0_env_gate.py::test_m0_no_ngx_core_not_found_error SKIPPED   [ 49%]
tests/test_m0_env_gate.py::test_m0_no_platform_error SKIPPED (M0 run...) [ 49%]
======================= 165 passed, 26 skipped in 16.67s =======================
```
...
Commit and push `test-results/20260918T132847Z/` — it is read directly from the repo.
