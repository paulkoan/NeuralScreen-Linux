...
```
tests/test_m0_env_gate.py::test_m0_no_ngx_core_not_found_error SKIPPED   [ 47%]
tests/test_m0_env_gate.py::test_m0_no_platform_error SKIPPED (M0 run...) [ 48%]
======================= 120 passed, 26 skipped in 7.32s ========================
```
...
Commit and push `test-results/20260916T175431Z/` — it is read directly from the repo.
