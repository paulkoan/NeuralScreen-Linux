...
tests/test_m0_env_gate.py::test_m0_no_platform_error SKIPPED (M0 run...) [ 46%]
======================= 141 passed, 26 skipped in 24.38s =======================
```
...
Commit and push `test-results/20260918T083240Z/` — it is read directly from the repo.
